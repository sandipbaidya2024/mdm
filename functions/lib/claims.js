...
exports.normalizeServerUdise = normalizeServerUdise;
exports.validateServerUdiseCode = validateServerUdiseCode;
exports.buildUdiseClaim = buildUdiseClaim;
exports.setUserUdiseClaim = setUserUdiseClaim;
exports.getUserUdiseClaim = getUserUdiseClaim;
const adminApp_1 = require("./adminApp");
/**
 * Normalizes a raw UDISE code string by trimming surrounding whitespace.
 */
function normalizeServerUdise(rawUdise) {
    if (!rawUdise || typeof rawUdise !== 'string')
        return '';
 ...
 */
function validateServerUdiseCode(udiseCode) {
 ...
 */
function buildUdiseClaim(udiseCode) {
    const normalized = normalizeServerUdise(udiseCode);
 ...
 */
async function setUserUdiseClaim(uid, udiseCode, authProvider) {
    ...
    const auth = authProvider || (0, adminApp_1.getAdminAuth)();
 ...
 */
async function getUserUdiseClaim(uid, authProvider) {
